...
#include "../QtLiveThreadDemo/workerthread.h"
...
QT_MOC_LITERAL(4, 29, 4), // "icon"
QT_MOC_LITERAL(5, 34, 15), // "fetchingStarted"
QT_MOC_LITERAL(6, 50, 16), // "fetchingFinished"
QT_MOC_LITERAL(7, 67, 9) // "fetchData"

    },
    "WorkerThread\0dataReady\0\0text\0icon\0"
    "fetchingStarted\0fetchingFinished\0"
    "fetchData"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataReady((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QPixmap(*)>(_a[2]))); break;
        case 1: _t->fetchingStarted(); break;
        case 2: _t->fetchingFinished(); break;
        case 3: _t->fetchData(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WorkerThread::*)(const QString & , const QPixmap & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::dataReady)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::fetchingStarted)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (WorkerThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::fetchingFinished)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::dataReady(const QString & _t1, const QPixmap & _t2)
{
...
// SIGNAL 1
void WorkerThread::fetchingStarted()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void WorkerThread::fetchingFinished()
{
